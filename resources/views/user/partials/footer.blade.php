    ...
    <div class="justify-content-between d-flex row">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mt-3 me-3">
            ...
            <p class="d-flex justify-content-center justify-content-md-end align-items-center">
                rottenbanana@gmail.com<i class="bi bi-envelope ms-3"></i></p>
            <p class="d-flex justify-content-center justify-content-md-end align-items-center">+ 62 234 567
                88
                <i class="bi bi-phone ms-3"></i>
            </p>
            <p class="d-flex justify-content-center justify-content-md-end align-items-center">+ 62 234 567
                89
                <i class="bi bi-printer ms-3"></i>
            </p>
        </div>
    </div>
    <hr class="my-3">
