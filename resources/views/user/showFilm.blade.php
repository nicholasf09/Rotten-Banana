        ...
        <div class="col-8" id="cardContainer">
                ...
                <div class="card-body" id="userCard">
                        ...
                        <div style="display: flex; justify-content: space-between">
                            <div class="profile-picture" id="akun">
                                <img src="https://www.murrayglass.com/wp-content/uploads/2020/10/avatar-2048x2048.jpeg"
                                    alt="Profile Picture">
                                <h5 class="card-title" style="display: inline; margin-right: 10px">{{$review['name']}}
                                </h5>
                                <input type="hidden" id="idAkun" value="{{$review['id']}}">
                            </div>
                    ...
                    <div style="display: flex; justify-content: space-between">
                        <p class="card-text"><small class="text-body-secondary"
                                id="createdUser">{{$review['created']}}</small></p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                    <p class="card-text"><small class="text-body-secondary" id="createdReview">{{$r['created']}}</small>
                    </p>
                    @endif
                </div>
            </div>
